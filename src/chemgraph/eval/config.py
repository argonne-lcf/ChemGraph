...
class BenchmarkConfig(BaseModel):
    ...
    dataset : str
        Path to a ground-truth JSON file (required).  Generate one with
        ``scripts/evaluations/generate_ground_truth.py``.  Accepts both
        the *list* format and the *dict* format.
    output_dir : str
    ...
    dataset: str = Field(
        description=(
            ...
            "(e.g. generated by scripts/evaluations/generate_ground_truth.py)."
        ),
    )
