"""Backward-compatibility alias for :mod:`chemgraph.mcp.mace_mcp_hpc`.

.. deprecated::
    This module has been renamed to ``chemgraph.mcp.mace_mcp_hpc``.
...
from chemgraph.mcp.mace_mcp_hpc import (  # noqa: F401
    extract_output_json,
    mcp,
    run_mace_ensemble,
    run_mace_single,
