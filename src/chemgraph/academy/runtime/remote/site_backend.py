...
class SiteBackend(Protocol):
    ...
    async def wait_ready(
        ...
        *,
        ...
        No dashboard-side deadline: submit-mode raises RuntimeError
        when PBS marks the job F/X/E (walltime, cancel, node fault);
        attach-mode raises RuntimeError when the ssh process exits.
        """
        ...
