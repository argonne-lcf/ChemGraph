...
4. Use `IRSpectrum` for vibrational frequency and intensities data. This includes one or more vibrational modes, typically expressed in units like cm⁻¹ and intensities.
