...
query = "Run geometry optimization for acetic acid using FIRE method and EMT calculator."
#query = "Run geometry optimization for the file sample.xyz using FIRE method and mace_mp calculator."
mess = cca.run(query)
