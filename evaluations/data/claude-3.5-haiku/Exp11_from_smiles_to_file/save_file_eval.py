...
def compare_llm_and_manual_workflow(
    manual_workflow_fp: str, llm_workflow_fp: str, print_diff=True, vib_task=False, save_task=False
):
...
def main(manual_workflow, llm_workflow, print_diff, vib_task, save_task):
    result = compare_llm_and_manual_workflow(
        manual_workflow, llm_workflow, print_diff, vib_task, save_task
    )
...
if __name__ == "__main__":
    ...
    main(args.manual_workflow, args.llm_workflow, args.print_diff, args.vib_task, args.save_task)
