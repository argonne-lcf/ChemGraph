...
from comp_chem_agent.prompt.claude_prompt import single_agent_prompt, formatter_prompt
...
def get_query(
    ...
    query_dict = {
        ...
        "name_to_gibbs": f"Calculate the Gibbs free energy of a molecule {name} using {method} potential at a temperature of 800K",
