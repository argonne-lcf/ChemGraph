...
def compare_llm_and_manual_workflow(manual_workflow_fp: str, llm_workflow_fp: str, print_diff=True):
...
def main(manual_workflow, llm_workflow, print_diff):
...
if __name__ == "__main__":
    ...
    main(args.manual_workflow, args.llm_workflow, args.print_diff)
