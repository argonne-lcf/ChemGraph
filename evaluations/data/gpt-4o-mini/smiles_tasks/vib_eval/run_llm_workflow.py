...
def get_query(
    ...
    """
    query_dict = {
        "atomsdata": f"What is the XYZ coordinate for this SMILES string {smiles}?",
        "opt_method": f"Perform geometry optimization for this SMILES string {smiles} using {method}",
        "vib_method": f"Run vibrational frequency calculation for this SMILES string {smiles} using {method}",
    }
