def get_query(
    ...
    query_dict = {
        "coordinate": {
            "query": lambda: f"Provide the XYZ coordinates corresponding to the SMILES string: {smiles}",
            "description": "Get atomic coordinates of the molecule",
        },
        "opt_method": {
            "query": lambda: f"Perform geometry optimization for the SMILES string {smiles} using {method}",
            "description": "Optimize molecular geometry using the specified method",
        },
        "vib_method": {
            "query": lambda: f"Run vibrational frequency calculation for the SMILES string {smiles} using {method}",
            "description": "Calculate vibrational frequencies using the specified method",
        },
        "enthalpy_method": {
            "query": lambda: f"Calculate the enthalpy of the SMILES string {smiles} using {method}",
            "description": "Calculate enthalpy using the specified method",
        },
        "entropy_method": {
            "query": lambda: f"Calculate the entropy of the SMILES string {smiles} using {method}",
            "description": "Calculate enthalpy using the specified method",
        },
        "gibbs_method_temperature_pressure": {
            "query": lambda: f"Calculate the Gibbs free energy of the SMILES string {smiles} at T={temperature}K and P={pressure}bar using {method}",
